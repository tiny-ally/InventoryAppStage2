...
public class MainActivity extends AppCompatActivity implements
    ...
    private void insertBook() {
        ...
        // and a specific book's attributes are the values.
        ...
        // Insert a new row for specific book into the provider using the ContentResolver.
        // Use the {@link BookEntry#CONTENT_URI} to indicate that we want to insert
        // into the books database table.
        // Receive the new content URI that will allow us to access specific books's data in the future.
